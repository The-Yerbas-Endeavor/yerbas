...
"""Verify that starting yerbasd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start yerbasd with -h for help text")
        ...
        self.log.info("Start yerbasd with -version for version information")
