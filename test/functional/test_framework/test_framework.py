...
class BitcoinTestFramework():
    ...
    def main(self):
        ...
        parser.add_option("--usecli", dest="usecli", default=False, action="store_true",
                          help="use yerbas-cli instead of RPC for all commands")
        parser.add_option("--yerbasd-arg", dest="dashd_extra_args", default=[], type='string', action='append',
                          help="Pass extra args to all yerbasd instances")
        ...
        self.options.bitcoind = os.getenv("BITCOIND", default=config["environment"]["BUILDDIR"] + '/src/yerbasd' + config["environment"]["EXEEXT"])
        self.options.bitcoincli = os.getenv("BITCOINCLI", default=config["environment"]["BUILDDIR"] + '/src/yerbas-cli' + config["environment"]["EXEEXT"])
...
def skip_if_no_bitcoind_zmq(test_instance):
    """Skip the running test if yerbasd has not been compiled with zmq support."""
    config = configparser.ConfigParser()
