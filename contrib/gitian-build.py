...
def setup():
    ...
    if not os.path.isdir('yerbas-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/yerbas/yerbas-detached-sigs.git'])
    if not os.path.isdir('gitian-builder'):
        subprocess.check_call(['git', 'clone', 'https://github.com/devrandom/gitian-builder.git'])
    if not os.path.isdir('yerbas'):
        subprocess.check_call(['git', 'clone', 'https://github.com/yerbas/yerbas.git'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/yerbas/yerbas', help='Specify the URL of the repository. Default is %(default)s')
