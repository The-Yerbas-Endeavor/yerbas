# Linearize
Construct a linear, no-fork, best version of the Yerbas blockchain. The scripts
...
JSON-RPC server. Running `yerbasd` or `yerbas-qt -server` will be sufficient.
...
* `input`: yerbasd blocks/ directory containing blkNNNNN.dat
