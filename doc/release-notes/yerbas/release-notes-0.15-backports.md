...
- [`2be67c760`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/2be67c760) Merge #12324: speed up Unserialize_impl for prevector
...
- [`c743111c6`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/c743111c6) Merge #11578: net: Add missing lock in ProcessHeadersMessage(...)
...
- [`cbf59efef`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/cbf59efef) Implement WalletModel::IsSpendable for CScript
...
- [`703f4c77a`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/703f4c77a) Fix stderr related issues
...
- [`689eff3aa`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/689eff3aa) Drop unused GetScriptForWitness
...
- [`3e7ff3306`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/3e7ff3306) Merge #10835: Rename member field according to the style guide
...
- [`3980caf20`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/3980caf20) re-add import shutil
...
- [`ae488ba3d`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/ae488ba3d) Merge #10885: Reject invalid wallets
...
- [`6096212d5`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/6096212d5) Merge #10883: Rename -usewallet to -rpcwallet
...
- [`083c49e1d`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/083c49e1d) Merge #10837: Fix resource leak on error in GetDevURandom
...
- [`b195cbb5e`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/b195cbb5e) Merge #10651: Verify binaries from bitcoincore.org and bitcoin.org
...
- [`64ef42c79`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/64ef42c79) Merge #10446: net: avoid extra dns query per seed
...
- [`0cb552a20`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/0cb552a20) Merge #10377: Use rdrand as entropy source on supported platforms
...
- [`37659cd52`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/37659cd52) Merge #10431: Prevent shadowing the global dustRelayFee
...
- [`a8c202081`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/a8c202081) remove unused import cont.
...
- [`64d4113e0`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/64d4113e0) Merge #10061: [net] Added SetSocketNoDelay() utility function
...
- [`d523ed81e`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/d523ed81e) drop segwit 10318
...
- [`fc5e461ee`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/fc5e461ee) Merge #10222: [tests] test_runner - check unicode
- [`73a5d9bfd`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/73a5d9bfd) add `--quiet` to `test_runner.py`, replicates bitcoin#10105
- [`22c4cd7b0`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/22c4cd7b0) Merge #10159: [tests] color test results and sort alphabetically
- [`9c863edd9`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/9c863edd9) Merge #9780: Suppress noisy output from qa tests in Travis
- [`98f3e295c`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/98f3e295c) add `&& llmq::IsOldInstantSendEnabled()` to instantsend max value check
- [`a651f0d0f`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/a651f0d0f) adjust test_runner.py check if yerbasd is running
- [`74830ee2a`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/74830ee2a) adjust spork5 code in wallet.cpp
- [`4c7b47e28`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/4c7b47e28) Resolve comment, add check for fUseInstantSend and set value equal to the max value
- [`5152e751c`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/5152e751c) Notify UI/external scripts about wallet txes locks
- [`dfabead29`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/dfabead29) Merge #10264: [test] Add tests for getconnectioncount, getnettotals and ping
- [`4daceb9fe`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/4daceb9fe) Merge #10224: [test] Add test for getaddednodeinfo
- [`05139e3eb`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/05139e3eb) remove MyNodeConnCB Class and references
- [`2d771c95a`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/2d771c95a) Merge #10169: [tests] Remove func test code duplication
- [`146cae956`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/146cae956) Merge #10234: [net] listbanned RPC and QT should show correct banned subnets
- [`ed71579cc`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/ed71579cc) Merge #10093: [Qt] Don't add arguments of sensitive command to console window
- [`60aa17e0a`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/60aa17e0a) Merge #10180: [trivial] Fix typos (tempoarily → temporarily, inadvertantly → inadvertently)
- [`f097b2d94`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/f097b2d94) Merge #10281: doc: Add RPC interface guidelines
- [`717e0957e`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/717e0957e) Merge #10292: Improved efficiency in COutPoint constructors
- [`82feee353`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/82feee353) Merge #10305: Fix potential NPD introduced in b297426c
- [`0326e21a8`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/0326e21a8) Merge #10290: Add -stopatheight for benchmarking
- [`c2dd5cd33`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/c2dd5cd33) Merge #10256: [test] Add test for gettxout to wallet.py
- [`ed68d2ca1`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/ed68d2ca1) Merge #10075: Remove unused C++ code not covered by unit tests
- [`d9ac44740`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/d9ac44740) Merge #10283: Cleanup: reduce to one GetMinimumFee call signature
- [`94c79e869`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/94c79e869) Merge #10280: [test] Unit test amount.h/amount.cpp
- [`ef84ea4fc`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/ef84ea4fc) Merge #9743: Fix several potential issues found by sanitizers
- [`1dec8e693`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/1dec8e693) Merge #10278: [test] Add Unit Test for GetListenPort
- [`b9ccc7dd6`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/b9ccc7dd6) Merge #9930: Trivial: Correct indentation and bracing
- [`db2f8cb13`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/db2f8cb13) Merge #10225: [test] Add aborttrescan tests
- [`95e30b2ff`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/95e30b2ff) Merge #10263: Trivial: fix fee estimate write error log message
- [`5bde530fa`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/5bde530fa) Merge #10270: Remove Clang workaround for Boost 1.46
- [`f6c5d5802`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/f6c5d5802) Merge #10272: [Tests] Prevent warning: variable 'x' is uninitialized
- [`198558a36`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/198558a36) Merge #9792: FastRandomContext improvements and switch to ChaCha20
- [`b76b91d82`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/b76b91d82) Merge #10197: [tests] Functional test warnings
- [`46db8eb68`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/46db8eb68) Merge #10168: Fix build warning from #error text
- [`1dde64aaa`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/1dde64aaa) Merge #10155: build: Deduplicate version numbers
- [`34a1e93ca`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/34a1e93ca) remove UpdatedTransaction calls in instantsend code
- [`69b42ce67`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/69b42ce67) Merge #10165: [Wallet] Refactoring by using CInputCoin instead of std::pair
- [`d9a4dea61`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/d9a4dea61) Remove CValidationInterface::UpdatedTransaction
- [`131e94ef2`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/131e94ef2) Merge #10201: pass Consensus::Params& to functions in validation.cpp and make them static
- [`9be672204`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/9be672204) Merge #8524: Precompute sighashes
- [`56d1d13c4`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/56d1d13c4) Backport 8824 (#2968)
- [`07b4c08bd`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/07b4c08bd) Merge #9951: Wallet database handling abstractions/simplifications
- [`83d0637f2`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/83d0637f2) Merge #10097: Move zmq test skipping logic into individual test case.
- [`14cbf547c`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/14cbf547c) Merge #10023: [tests] remove maxblocksinflight.py (functionality covered by other test)
- [`6fb286686`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/6fb286686) Merge #10229: Tests: Add test for getdifficulty
- [`7cf74ddbc`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/7cf74ddbc) Merge #10239: Make Boost use std::atomic internally
- [`3d46bd3e7`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/3d46bd3e7) Merge #10181: Include cleanup
- [`ebded7d83`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/ebded7d83) Update help text via gen-manpages.sh
- [`40fd1b168`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/40fd1b168) Make Consensus::LLMQType serializable and use it in serialized classes
- [`186f7d286`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/186f7d286) Implement support for explicit enum serialization
- [`d36c408a6`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/d36c408a6) bump version in fees.cpp
- [`81afb1058`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/81afb1058) remove `nodehandling.py`
- [`788973a8a`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/788973a8a) Fix disconnect_ban.py
- [`e6a0b2162`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/e6a0b2162) Add missing include for CKeyID
- [`60a8a9357`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/60a8a9357) Drop CDSNotificationInterface::SyncTransaction()
- [`95f4cf441`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/95f4cf441) add `#include "policy/fees.h"` to validation.cpp
- [`f8c5a14f3`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/f8c5a14f3) Merge #9942: Refactor CBlockPolicyEstimator
- [`8675a5064`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/8675a5064) Add TODO comment about need to remove compatibility code
- [`617c4a4cc`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/617c4a4cc) Use mapDSTX.find() instead of count() and []
- [`8df25bbfe`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/8df25bbfe) Call and implemente new signals in CPrivateSend
- [`816efa9cd`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/816efa9cd) Add missing directories to CMakeLists.txt and sort the list
- [`715a3e951`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/715a3e951) Move updating of txFirstSeenTime into TransactionAddedToMempool and BlockConnected
- [`a61127e1a`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/a61127e1a) Move filling of blockTxs into BlockConnected
- [`d4e75abbf`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/d4e75abbf) Call new signals in CChainLocksHandler
- [`25c40fe40`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/25c40fe40) Fix typo
- [`523304537`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/523304537) Don't check for posInBlock when updating pindexMined
- [`0b4f7b9b6`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/0b4f7b9b6) Move removal of mined-locks info to BlockDisconnected
- [`b645757be`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/b645757be) Call RemoveConflictedTx from BlockConnected instead of ProcessNewTransaction
- [`b36f0a324`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/b36f0a324) Call new signals instead of SyncTransaction on CInstantSendManager
- [`6afa605f6`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/6afa605f6) Pass disconnected/deleted pindex instead of pprev into BlockDisconnected
- [`9b8a750c9`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/9b8a750c9) More `boost::filesystem`->`fs` and some related cleanup
- [`250195185`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/250195185) Adjust CDSNotificationInterface to align with CValidationInterface changes
- [`d180061b8`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/d180061b8) Pass block index via BlockDisconnected
- [`282d1554d`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/282d1554d) adjust examples/yerbas.conf
- [`e451325d6`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/e451325d6) Merge #10186: Remove SYNC_TRANSACTION_NOT_IN_BLOCK magic number
- [`60438257a`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/60438257a) Merge #9725: CValidationInterface Cleanups
- [`f893ac66c`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/f893ac66c) Merge #10124: [test] Suppress test logging spam
- [`a54ff70ff`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/a54ff70ff) Merge #9902: Lightweight abstraction of boost::filesystem
- [`515343963`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/515343963) Merge #10036: Fix init README format to render correctly on github
- [`c8a565d6e`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/c8a565d6e) Merge #10090: Update bitcoin.conf with example for pruning
- [`6f558270d`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/6f558270d) Merge #10143: [net] Allow disconnectnode RPC to be called with node id
- [`4efa99c2d`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/4efa99c2d) Merge #10221: Stop treating coinbase outputs differently in GUI: show them at 1conf
- [`16053cd52`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/16053cd52) Merge #10226: wallet: Use boost to more portably ensure -wallet specifies only a filename
- [`7fa60a1c7`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/7fa60a1c7) Merge #10219: Tests: Order Python Tests Differently
- [`0b232fd1c`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/0b232fd1c) Merge #10208: [wallet] Rescan abortability
- [`55d1251ff`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/55d1251ff) Merge #9480: De-duplicate SignatureCacheHasher
- [`29194b1f5`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/29194b1f5) Backport Bitcoin#9424, Bitcoin#10123 and Bitcoin#10153 (#2918)
- [`15fa1873d`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/15fa1873d) Drop redundant imports and fix related code
- [`6f91144f2`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/6f91144f2) Fix p2p-fingerprint.py
- [`92fed9254`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/92fed9254) Fix and re-enable pruning.py
- [`bfeb5bca4`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/bfeb5bca4) fix txindex.py and add it to extended scripts
- [`c37008a45`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/c37008a45) update dip4-coinbasemerkalroots.py and llmq-is-cl-conflicts.py
- [`7fd979cc0`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/7fd979cc0) Merge #10114: [tests] sync_with_ping should assert that ping hasn't timed out
- [`4121daba2`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/4121daba2) Merge #10098: Make qt wallet test compatible with qt4
- [`cc06ef551`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/cc06ef551) Merge #10109: Remove SingleNodeConnCB
- [`94aa904c0`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/94aa904c0) Merge #10107: Remove unused variable. Remove accidental trailing semicolons in Python code
- [`404e244d1`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/404e244d1) Merge #10088: Trivial: move several relay options into the relay help group
- [`05cb5a058`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/05cb5a058) Merge #10108: ApproximateBestSubset should take inputs by reference, not value
- [`bfd63c179`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/bfd63c179) Merge #10076: [qa] combine_logs: Use ordered list for logfiles
- [`e57559a8d`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/e57559a8d) Merge #10096: Check that all test scripts in test/functional are being run
- [`c2258978b`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/c2258978b) Merge #10057: [init] Deduplicated sigaction() boilerplate
- [`6bb55d547`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/6bb55d547) Merge #10056: [zmq] Call va_end() on va_start()ed args.
- [`142b5cba0`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/142b5cba0) Merge #10073: Actually run assumevalid.py
- [`14001a3d9`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/14001a3d9) Merge #10085: Docs: remove 'noconnect' option
- [`120941793`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/120941793) Merge #10083: [QA] Renaming rawTx into rawtx
- [`1781c7a70`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/1781c7a70) Merge #10069: [QA] Fix typo in fundrawtransaction test
- [`379312931`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/379312931) Merge #9946: Fix build errors if spaces in path or parent directory
- [`ba20c9031`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/ba20c9031) Merge #10067: [trivial] Dead code removal
- [`ae05068c5`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/ae05068c5) Merge #10053: [test] Allow functional test cases to be skipped
- [`9f07f489d`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/9f07f489d) Merge #10047: [tests] Remove unused variables and imports
- [`96a5f5730`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/96a5f5730) Merge #9500: [Qt][RPC] Autocomplete commands for 'help' command in debug console
- [`07e0567dc`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/07e0567dc) Merge #9558: Clarify assumptions made about when BlockCheck is called
- [`2aa3f890d`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/2aa3f890d) Merge #10029: Fix parameter naming inconsistencies between .h and .cpp files
- [`7edb9e15a`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/7edb9e15a) Merge #10017: combine_logs.py - aggregates log files from multiple bitcoinds during functional tests.
- [`f2e976a05`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/f2e976a05) Merge #10045: [trivial] Fix typos in comments
- [`2c833eff3`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/2c833eff3) Merge #10039: Fix compile errors with Qt 5.3.2 and Boost 1.55.0
- [`a6eee07f2`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/a6eee07f2) Merge bitcoin#9963: util: Properly handle errors during log message formatting (#2917)
- [`67c735b15`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/67c735b15) s/bitcoin-config.h/yerbas-config.h/
- [`2f63322cd`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/2f63322cd) yerbasify "Finding reviewers" section to be more relevant
- [`e7a21faa2`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/e7a21faa2) Merge Bitcoin#9960: Trivial: Add const modifier to GetHDChain and IsHDEnabled
- [`eecc72436`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/eecc72436) Merge #10564: Return early in IsBanned.
- [`742744f25`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/742744f25) Merge #10522: [wallet] Remove unused variables
- [`31bb4622a`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/31bb4622a) Merge #10538: [trivial] Fix typo: "occurrences" (misspelled as "occurrances")
- [`f57063155`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/f57063155) Merge #10514: Bugfix: missing == 0 after randrange
- [`b708ea819`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/b708ea819) Merge #10469: Fixing typo in rpcdump.cpp
- [`55dc3dae5`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/55dc3dae5) Merge #10486: devtools: Retry after signing fails in github-merge
- [`0d2f2b361`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/0d2f2b361) Merge #10273: [scripts] Minor improvements to `macdeployqtplus` script.
- [`317b797e2`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/317b797e2) Merge #9670: contrib: github-merge improvements
- [`a3467dd26`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/a3467dd26) Merge #10228: build: regenerate bitcoin-config.h as necessary
- [`a089c9325`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/a089c9325) Merge #9827: Improve ScanForWalletTransactions return value
- [`383d1819a`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/383d1819a) Merge #10211: [doc] Contributor fixes & new "finding reviewers" section
- [`632956a80`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/632956a80) Merge #9693: Prevent integer overflow in ReadVarInt.
- [`0db1328a2`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/0db1328a2) Merge #10177: Changed "Send" button default status from true to false
- [`dccd6970b`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/dccd6970b) Merge #10164: Wallet: reduce excess logic InMempool()
- [`23530a88a`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/23530a88a) Merge #10135: [p2p] Send the correct error code in reject messages
- [`e5ecff6e8`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/e5ecff6e8) Merge #9949: [bench] Avoid function call arguments which are pointers to uninitialized values
- [`3dcaf4749`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/3dcaf4749) Merge #10166: Ignore Doxyfile generated from Doxyfile.in template.
- [`13cdff498`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/13cdff498) Merge #10104: linearize script: Option to use RPC cookie
- [`f471b75ae`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/f471b75ae) Merge #9533: Allow non-power-of-2 signature cache sizes
- [`198808894`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/198808894) Merge #10058: No need to use OpenSSL malloc/free
- [`22b21f50c`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/22b21f50c) Merge #10077: [qa] Add setnetworkactive smoke test
- [`9fa51cc66`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/9fa51cc66) Merge #10072: Remove sources of unreliablility in extended functional tests
- [`818ec218d`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/818ec218d) Merge #10128: Speed Up CuckooCache tests
- [`07ed44df6`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/07ed44df6) Merge #10136: build: Disable Wshadow warning
- [`b5968cd7a`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/b5968cd7a) Merge #10129: scheduler: fix sub-second precision with boost < 1.50
- [`16641e1b1`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/16641e1b1) Merge #10095: refactor: Move GetDifficulty out of `rpc/server.h`
- [`6edbc9ceb`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/6edbc9ceb) Merge bitcoin#9956: Reorganise qa directory (#2912)
- [`ace96a941`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/ace96a941) Drop xvfb and run tests in linux64_nowallet
- [`fc1b3772d`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/fc1b3772d) Merge #10899: [test] Qt: Use `_putenv_s` instead of setenv on Windows builds
- [`f8c3f9f7d`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/f8c3f9f7d) Merge #10142: Run bitcoin_test-qt under minimal QPA platform
- [`826846f15`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/826846f15) Review suggestions
- [`9cef545ac`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/9cef545ac) code review
- [`720f13d69`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/720f13d69) add a comment linking to xvfb documentation
- [`5f4519804`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/5f4519804) Merge #9734: Add updating of chainTxData to release process
- [`1914c2d78`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/1914c2d78) Merge #10038: Add mallocinfo mode to `getmemoryinfo` RPC
- [`de0919220`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/de0919220) Merge #10027: Set to nullptr after delete
- [`d56322285`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/d56322285) Merge #10033: Trivial: Fix typo in key.h comment
- [`22563f369`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/22563f369) Merge #10024: [trivial] Use log.info() instead of print() in remaining functional test cases.
- [`dd91bd7b3`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/dd91bd7b3) Merge #9911: Wshadow: various gcc fixes
- [`eea802738`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/eea802738) Merge #9987: Remove unused code
- [`6376da03f`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/6376da03f) Merge #9818: Save watch only key timestamps when reimporting keys
- [`8e0968faf`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/8e0968faf) Merge #9690: Change 'Clear' button string to 'Reset'
- [`aee4472ac`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/aee4472ac) Merge #9974: Add basic Qt wallet test
- [`ae9ca8459`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/ae9ca8459) Merge #10010: util: rename variable to avoid shadowing
- [`594b78fdf`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/594b78fdf) Merge #9921: build: Probe MSG_DONTWAIT in the same way as MSG_NOSIGNAL
- [`5ae202da9`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/5ae202da9) Merge #9842: Fix RPC failure testing (continuation of #9707)
- [`1cfda206a`](https://github.com/The-Yerbas-Endeavor/yerbas/commit/1cfda206a) Merge #9993: Initialize nRelockTime
