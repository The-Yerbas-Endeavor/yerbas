...
//! Interface for the src/evo part of a yerbas node (yerbasd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a yerbas node (yerbasd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a yerbas node (yerbasd process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a yerbas node (yerbasd process).
class Node
{
public:
    virtual ~Node() {}
