    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:\n"
            "  yerbas-qt [command-line options]                     \n";
...
These denominations are 0.001 YERB, 0.01 YERB, 0.1 YERB, 1 YERB and 10 YERB -- sort of like the paper money you use every day.</li> \
