...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("yerbas://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'yerbas://' is not a valid URI. Use 'yerbas:' instead."),
            CClientUIInterface::MSG_ERROR);
    }
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // yerbas: URI
    {
