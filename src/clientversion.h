...
#error Client version information missing: version is not defined by yerbas-config.h or in any other way
#endif
...
/**
 * yerbasd-res.rc includes this file, but it cannot cope with real c++ code.
